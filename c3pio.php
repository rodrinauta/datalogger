...
include 'obtener-datos-4.php'; // Probando
//include 'obtener-datos-3.php'; // Probando
//include 'fecha.php';                       // Establecer fecha del DustMate
//include 'iniciar-captura.php';
//include 'detener-captura.php';           // Descriptivo
//include 'captura-samples-offline-2.php'; // Supuestamente ocho mediciones en DustMate
//include 'captura-samples-offline.php';   // Dos mediciones en DustMate
